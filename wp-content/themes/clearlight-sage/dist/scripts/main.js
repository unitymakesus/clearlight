...
/******/ 	__webpack_require__.p = "/wp-content/themes/clearlight-sage/dist/";
/******/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__routes_gallery__ = __webpack_require__(10);
...
var routes = new __WEBPACK_IMPORTED_MODULE_2__util_Router__["a" /* default */]({
  ...
  /** Gallery pages */
  singleGallery: __WEBPACK_IMPORTED_MODULE_5__routes_gallery__["a" /* default */],
});
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony default export */ __webpack_exports__["a"] = ({
  init: function init() {
    ...
    var img_blur = $('#video-blur-wrapper').data('poster');
    var mp4_blur = $('#video-blur-wrapper').data('mp4');
    var webm_blur = $('#video-blur-wrapper').data('webm');

    // Set constants for sharp videos
    var img_sharp = $('#video-sharp-wrapper').data('poster');
    var mp4_sharp = $('#video-sharp-wrapper').data('mp4');
    var webm_sharp = $('#video-sharp-wrapper').data('webm');
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_macy__ = __webpack_require__(11);
